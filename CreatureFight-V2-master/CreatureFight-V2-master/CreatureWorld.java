...
public class CreatureWorld extends World
{
    ...
    public void act()
    {
        ...
        if( turnNumber == 0 )
        {
            ...
            playerOneName = JOptionPane.showInputDialog( null, "Player One, please enter your name", "PLAYER ONE NAME ENTRY" ,JOptionPane.QUESTION_MESSAGE );
            ...
            playerTwoName = JOptionPane.showInputDialog( null, "Player Two, please enter your name", "PLAYER TWO NAME ENTRY" ,JOptionPane.QUESTION_MESSAGE );
        ...
        //TODO (20): Otherwise, if turnNumber is equal to 1...
          ...
          showText(playerOneName, getHeight()/2,getWidth()/2 );
        }
        //TODO (22): Otherwise...
        else
        {
            ...
            showText(playerTwoName, getHeight()/2 , getWidth()/2 );
        }
    ...
    public Creature getPlayerTwo()
    {
     ...
     /**
      * getTurnNumber gets the turn number and then returns it 
      * @param None Their are no parameters
      * @return returns an int ((that represents)) an integer
      */
    ...
    /**
     * setTurnNumber sets the turn number to the next turn 
     * @param int turn is the parameter
